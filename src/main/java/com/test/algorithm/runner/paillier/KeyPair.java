...
public class KeyPair implements Serializable {
	 ...
	 * @return The corresponding plaintext. If an upper bound was given to
	 *         {@link KeyPairBuilder}, the result can also be negative. See
	 *         {@link KeyPairBuilder#upperBound(BigInteger)} for details.
	 */
